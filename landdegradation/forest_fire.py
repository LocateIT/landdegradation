...
def forest_fire(prefire_start,prefire_end,postfire_start,postfire_end, geometry, platform, EXECUTION_ID,logger):
    """
    ===========================================================================================
    ...
    return TEImage(pre_mos,[BandInfo("Pre-fire image", add_to_map=True, metadata={'prefire_start':prefire_start,'prefire_end':prefire_end, 'postfire_start':postfire_start, 'postfire_end':postfire_end})])

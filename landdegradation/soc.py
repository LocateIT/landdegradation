...
def soc(geometry,year_start, year_end, fl, remap_matrix, dl_annual_lc, EXECUTION_ID, 
        logger):
    """
    ...
    # soc
    soc = ee.Image("users/geflanddegradation/toolbox_datasets/soc_sgrid_30cm").clip(area)
